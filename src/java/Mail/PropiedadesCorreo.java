...
public class PropiedadesCorreo {
    ...
    public static void envioCorreo(String servidor, String puerto, final String usuario, final String clave,
            String destino, String asunto, String mensaje) throws MessagingException {
        ...
        InternetAddress[] direciones = {new InternetAddress(destino)};
