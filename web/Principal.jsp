        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-info">           
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li  class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="ControladorProveedor?menu=Proveedor&accion=Listar" target="myFrame">Proveedores</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn btn-outline-light" href="ControladorCompras?menu=NuevaCompra&accion=default" target="myFrame">Nueva Compra</a>
                    </li>
                </ul>                
            </div>
            <div class="dropdown">
