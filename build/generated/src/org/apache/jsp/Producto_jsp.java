...
public final class Producto_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        <form name=\"frmProductos\" action=\"ControladorProducto?menu=Producto\" method=\"POST\" onsubmit=\"return validar()\">\n");
      ...
      out.write("                            <input class=\"btn btn-danger\" type=\"submit\" value=\"Generar PDF\"> \n");
      out.write("                        </form>  \n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      ...
      out.write("                                dni = document.frmProductos.txtDni.value;\n");
      out.write("                                nom = document.frmProductos.txtNombres.value;\n");
      out.write("                                dir = document.frmProductos.txtTel.value;\n");
      out.write("\n");
      out.write("                                if (dni.length == 0) {\n");
      out.write("                                    alertify.alert(\"Aviso\", \"Ingrese un nombre\").set('label', 'Ok');\n");
      out.write("                                    return false;\n");
      out.write("                                } else if (nom.length == 0) {\n");
      out.write("                                    alertify.alert(\"Aviso\", \"Ingrese el precio\").set('label', 'Ok');\n");
      out.write("                                    return false;\n");
      out.write("                                } else if (dir.length == 0) {\n");
      out.write("                                    alertify.alert(\"Aviso\", \"Ingrese una cantidad\").set('label', 'Ok');\n");
      out.write("                                    return false;\n");
      out.write("                                }\n");
      out.write("                            }\n");
      out.write("        </script>\n");
